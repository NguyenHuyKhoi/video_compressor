...
export const Video: FC<Props> = ({data, style, onPress}) => {
  const {size, base64Thumb, duration, width, height, createdAt} = data;
  console.log('Created at: ', createdAt, new Date().getTime());
  const date = new Date(parseInt(createdAt, 10) * 1000);
  return (
    <TouchableOpacity
